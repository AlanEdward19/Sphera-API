...
public class ReopenBillingEntriesCommandHandler(
    SpheraDbContext dbContext,
    ILogger<ReopenBillingEntriesCommandHandler> logger)
    : IHandler<ReopenBillingEntriesCommand, BulkActionResultDTO>
{
    public async Task<IResultDTO<BulkActionResultDTO>> HandleAsync(
        ReopenBillingEntriesCommand request,
        HttpContext context,
