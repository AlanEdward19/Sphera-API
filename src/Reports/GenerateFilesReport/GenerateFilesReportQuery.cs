...
/// <summary>
/// Represents a query for generating a report of files based on specified criteria.
/// </summary>
/// <remarks>
/// This class contains various filters and parameters that determine the scope and content
/// of the files report generated by the system. The query supports optional filtering
/// by partner, client, and service, as well as by expiration status and date ranges.
/// </remarks>
/// <example>
/// Use this query class to provide input parameters when requesting the generation of a files report.
/// The query is consumed by the report handler to fetch and process matching data.
/// </example>
