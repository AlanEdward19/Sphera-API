...
namespace Sphera.API.External.Database.Migrations
{
    ...
    [Migration("20260325232231_AddScheduleEventInvites")]
    partial class AddScheduleEventInvites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sphera.API.Schedules.ScheduleEventInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("InvitedUserId")
                        .HasDatabaseName("IX_ScheduleEventInvites_InvitedUserId");

                    b.HasIndex("ScheduleEventId")
                        .HasDatabaseName("IX_ScheduleEventInvites_ScheduleEventId");

                    b.ToTable("ScheduleEventInvites", "dbo");
                });
            ...
            modelBuilder.Entity("Sphera.API.Schedules.ScheduleEventInvite", b =>
                {
                    b.HasOne("Sphera.API.Users.User", "InvitedUser")
                        .WithMany()
                    ...
                    b.HasOne("Sphera.API.Schedules.ScheduleEvent", "ScheduleEvent")
